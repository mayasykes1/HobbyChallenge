...
var scholarAges = [
    ...
    17, //Sabyatha
    14,  //Sophia
    18, //Master Scholar M-swag
    18 //Master Scholar Chlo $
]
...
var scholarHobbies = [
    ...
    "swimming", //Sophia
    "being a sassy sensei", //Master Scholar M-swag
    "promiscuous dancing" // Master Scholar Chlo $$
]

//for index in 0..<scholarNames.count {
//    print("Introducing...  \(scholarNames[index])! , \(scholarAges[index]), \(scholarHobbies[index])")
//}

for index in 0..<scholarNames.count {
    if scholarAges[index] == 15 {
        print("Introdducing...  \(scholarNames[index])! , \(scholarAges[index]), \(scholarHobbies[index])")
